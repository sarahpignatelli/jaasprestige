<?php $__env->startSection('title', 'JAAS Prestige | Cars'); ?>
            ...
            <div class="col-md-3">
                <div class="textholder text-center font-weight-bold">
                    <?php if(auth()->guard()->guest()): ?>
                        <a class="join-now" href="<?php echo e(route('register')); ?>"><?php echo e(__('GET PRESTIGE')); ?></a>
                    <?php else: ?>
                        <a class="join-now" href="<?php echo e(url('booking')); ?>"><?php echo e(__('GET PRESTIGE')); ?></a> 
                    <?php endif; ?>
                    <br>
                </div>
            </div>
