<?php $__env->startSection('title', 'JAAS Prestige | Locations'); ?>
    ...
    <script type="text/javascript">
        function initMap() {
            ...
            for(let index=0; index<carList.length; index++) {
                ...
                contentString:"<div class=\"text-center\"><h2>" + carList[index][1] + "</h2>" + carList[index][0] + "<br><br><?php if(auth()->guard()->guest()): ?><a class=\"join-now text-center\" href=\"<?php echo e(url('register')); ?>\"><?php echo e(__('GET PRESTIGE')); ?></a><?php else: ?><a class=\"join-now\" href=\"<?php echo e(url('booking')); ?>\"><?php echo e(__('GET PRESTIGE')); ?></a><?php endif; ?></div>"
                };
                addMarker(marker);
            }
